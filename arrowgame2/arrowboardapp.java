...
public class arrowboardapp extends Applet implements ActionListener, MouseListener, MouseMotionListener{
Timer timer;
Head head;
body b;
leg l;
...
for(int i=0; i<am.size(); i++){
ammo p=am.get(i);
g2d.drawString("Corner1x:"+corner3x , 15, 15);
g2d.drawString("Corner1y:"+corner3y, 800, 15);
}
length2=length;
if(length2>1100){
length2=1100;
}
g2d.drawString("Meters Bow Stretched:"+(length2/1100), 120, 100);
